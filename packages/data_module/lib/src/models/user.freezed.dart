...
class _$UserTearOff {
  ...
  _User call({required String name, required int age, required double salary}) {
    return _User(
      name: name,
      age: age,
      salary: salary,
...
class _$_User implements _User {
  const _$_User({required this.name, required this.age, required this.salary});
...
abstract class _User implements User {
  const factory _User(
      ...
      required int age,
      required double salary}) = _$_User;
